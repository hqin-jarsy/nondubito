...
(function() {
  ...
  Object.assign(variants, {
    ...
    "意见收到了，然后呢？": "意見收到了，然後呢？",
    "从排班意见、练琴记录到报名条件：写下来的情况，后来有没有真的被用来安排事情？先看这些日常场景，再分清“收到了”和“用上了”。仅提供简体中文、繁体中文与英文。": "從排班意見、練琴記錄到報名條件：寫下來的情況，後來有沒有真的被用來安排事情？先看這些日常場景，再分清“收到了”和“用上了”。僅提供簡體中文、繁體中文與英文。",
    "第 00E 篇 · 入门散文": "第 00E 篇 · 入門散文",
    "收到意见，不等于安排时真的考虑过；结果没变，也不等于意见没用上。从处理经过，看写下的情况有没有参与判断。简中／繁中／EN。": "收到意見，不等於安排時真的考慮過；結果沒變，也不等於意見沒用上。從處理經過，看寫下的情況有沒有參與判斷。簡中／繁中／EN。"
  });
