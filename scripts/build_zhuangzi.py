...
<a href="42.html">{tri('Meet the people who do things →','看看那些做事的人 →','看看那些做事的人 →')}<small>{tri('Craft, attention, life · essays 42–55 available · more to come','技艺、专注与生活 · 42—55 已可读 · 后续编辑中','技藝、專注與生活 · 42—55 已可讀 · 後續編輯中')}</small></a></div></section>
