...
<a href="30.html">{tri('How do we judge a passage? →','怎样辨析一段文字 →','怎樣辨析一段文字 →')}<small>{tri('Reasons and limits · essays 30–35 available · later readings in preparation','理由与限度 · 30—35 已可读 · 后续编辑中','理由與限度 · 30—35 已可讀 · 後續編輯中')}</small></a>
